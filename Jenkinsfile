...
/*         stage('Deploy App to Kubernetes') {
            steps{
                script {
                    kubernetesDeploy( configs: "template-microservice-k8s-deployment.yaml", kubeconfigId: "k8s")
                    kubernetesDeploy( configs: "template-microservice-k8s-svc.yaml", kubeconfigId: "k8s")
                }
            }
        } */
